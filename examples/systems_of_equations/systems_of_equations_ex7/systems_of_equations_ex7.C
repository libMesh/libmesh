...
// material (which is an an extension of the linear elastic material model to the nonlinear
...
/**
 * This class handles residual and Jacobian assembly for the nonlinear system.
 */
