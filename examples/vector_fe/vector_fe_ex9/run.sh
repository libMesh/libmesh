...
options="cavity=true mms=true dim=2 element_type=TRI7 -ksp_type preonly -condensed_pc_type lu -condensed_pc_factor_shift_type NONZERO -snes_linesearch_type basic"
run_example_no_extra_options "$example_name" "$options"
...
options="cavity=false mms=true dim=2 element_type=TRI7 -ksp_type preonly -condensed_pc_type lu -condensed_pc_factor_shift_type NONZERO -snes_linesearch_type basic"
run_example_no_extra_options "$example_name" "$options"
...
options="cavity=true mms=false dim=2 element_type=TRI7 -ksp_type preonly -condensed_pc_type lu -condensed_pc_factor_shift_type NONZERO -snes_linesearch_type basic"
run_example_no_extra_options "$example_name" "$options"
...
options="cavity=false mms=false dim=2 element_type=TRI7 -ksp_type preonly -condensed_pc_type lu -condensed_pc_factor_shift_type NONZERO -snes_linesearch_type basic"
run_example_no_extra_options "$example_name" "$options"
