...
sources=`find base error_estimation fe geom mesh numerics parallel partitioning physics quadrature reduced_basis solution_transfer solvers systems utils -name "*.C" -o -name "*.c" -type f | LC_COLLATE=POSIX sort`
