					         ...
					         bool /*estimate_parent_error*/)
{
  ...
  projected_solution = NumericVector<Number>::build(mesh.communicator()).release();
  ...
  // an element it owns
  AutoPtr<NumericVector<Number> > localized_projected_residual = NumericVector<Number>::build(system.communicator());
  ...
  AutoPtr<NumericVector<Number> > localized_adjoint_solution = NumericVector<Number>::build(system.communicator());
