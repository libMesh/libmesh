...
template <>
void FE<0,RAVIART_THOMAS>::nodal_soln(const unsigned,
                                      const Elem *,
                                      const Order,
...
template <>
void FE<1,RAVIART_THOMAS>::nodal_soln(const unsigned,
                                      const Elem *,
                                      const Order,
                                      const std::vector<Number> &,
                                      std::vector<Number> &,
...
template <>
void FE<2,RAVIART_THOMAS>::nodal_soln(const unsigned vdim,
                                      const Elem * elem,
                                      const Order order,
                                      const std::vector<Number> & elem_soln,
                                      std::vector<Number> & nodal_soln,
...
template <>
void FE<3,RAVIART_THOMAS>::nodal_soln(const unsigned,
                                      const Elem * elem,
                                      const Order order,
                                      const std::vector<Number> & elem_soln,
                                      std::vector<Number> & nodal_soln,
...
template <>
void FE<0,L2_RAVIART_THOMAS>::nodal_soln(const unsigned,
                                         const Elem *,
                                         const Order,
                                         const std::vector<Number> &,
                                         std::vector<Number> &,
...
template <>
void FE<1,L2_RAVIART_THOMAS>::nodal_soln(const unsigned,
                                         const Elem *,
                                         const Order,
                                         const std::vector<Number> &,
                                         std::vector<Number> &,
...
template <>
void FE<2,L2_RAVIART_THOMAS>::nodal_soln(const unsigned vdim,
                                         const Elem * elem,
                                         const Order order,
                                         const std::vector<Number> & elem_soln,
                                         std::vector<Number> & nodal_soln,
...
template <>
void FE<3,L2_RAVIART_THOMAS>::nodal_soln(const unsigned,
                                         const Elem * elem,
                                         const Order order,
                                         const std::vector<Number> & elem_soln,
                                         std::vector<Number> & nodal_soln,
