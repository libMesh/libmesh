...
/**
 * \returns The 2 dimensional tensor product of one-dimensional Gauss-Lobatto nodal
...
const unsigned int second_deriv_pairs[3][2] = {{0, 0}, {0, 1}, {1, 1}};
