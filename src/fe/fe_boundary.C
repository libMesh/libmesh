...
LIBMESH_ERRORS_IN_LOW_D(HIERARCHIC_VEC)
LIBMESH_ERRORS_IN_LOW_D(L2_HIERARCHIC_VEC)
LIBMESH_ERRORS_IN_LOW_D(SIDE_HIERARCHIC)
LIBMESH_ERRORS_IN_LOW_D(LAGRANGE)
LIBMESH_ERRORS_IN_LOW_D(L2_LAGRANGE)
LIBMESH_ERRORS_IN_LOW_D(L2_LAGRANGE_GLL)
LIBMESH_ERRORS_IN_LOW_D(LAGRANGE_GLL)
LIBMESH_ERRORS_IN_LOW_D(LAGRANGE_VEC)
LIBMESH_ERRORS_IN_LOW_D(L2_LAGRANGE_VEC)
...
REINIT_AND_SIDE_MAPS(L2_LAGRANGE_GLL);
REINIT_AND_SIDE_MAPS(LAGRANGE_GLL);
REINIT_AND_SIDE_MAPS(L2_LAGRANGE_VEC);
REINIT_AND_SIDE_MAPS(HIERARCHIC);
REINIT_AND_SIDE_MAPS(HIERARCHIC_VEC);
REINIT_AND_SIDE_MAPS(L2_HIERARCHIC);
REINIT_AND_SIDE_MAPS(L2_HIERARCHIC_VEC);
...
template LIBMESH_EXPORT void FE<2,RAVIART_THOMAS>::reinit(Elem const *, unsigned int, Real, const std::vector<Point> * const, const std::vector<Real> * const);
template LIBMESH_EXPORT void FE<2,RAVIART_THOMAS>::side_map(Elem const *, Elem const *, const unsigned int, const std::vector<Point> &, std::vector<Point> &);
...
template LIBMESH_EXPORT void FE<3,RAVIART_THOMAS>::reinit(Elem const *, unsigned int, Real, const std::vector<Point> * const, const std::vector<Real> * const);
