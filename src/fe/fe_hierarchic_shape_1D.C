...
template <>
GeomReal FE<1,SIDE_HIERARCHIC>::shape(const ElemType,
                                      const Order,
                                      const unsigned int i,
                                      const Point & p)
{
...
template <>
GeomReal FE<1,SIDE_HIERARCHIC>::shape(const Elem *,
                                      const Order,
                                      const unsigned int i,
                                      const Point & p,
                                      const bool)
...
template <>
GeomReal FE<1,SIDE_HIERARCHIC>::shape(const FEType,
                                      const Elem *,
                                      const unsigned int i,
                                      const Point & p,
                                      const bool)
...
template <>
GeomReal FE<1,SIDE_HIERARCHIC>::shape_deriv(const ElemType,
                                            const Order,
                                            const unsigned int,
                                            const unsigned int,
                                            const Point &)
...
template <>
GeomReal FE<1,SIDE_HIERARCHIC>::shape_deriv(const Elem *,
                                            const Order,
                                            const unsigned int,
                                            const unsigned int,
                                            const Point &,
...
template <>
GeomReal FE<1,SIDE_HIERARCHIC>::shape_deriv(const FEType,
                                            const Elem *,
                                            const unsigned int,
                                            const unsigned int,
                                            const Point &,
...
template <>
GeomReal FE<1,SIDE_HIERARCHIC>::shape_second_deriv(const ElemType,
                                                   const Order,
                                                   const unsigned int,
                                                   const unsigned int,
                                                   const Point &)
...
template <>
GeomReal FE<1,SIDE_HIERARCHIC>::shape_second_deriv(const Elem *,
                                                   const Order,
                                                   const unsigned int,
                                                   const unsigned int,
                                                   const Point &,
...
template <>
GeomReal FE<1,SIDE_HIERARCHIC>::shape_second_deriv(const FEType,
                                                   const Elem *,
                                                   const unsigned int,
                                                   const unsigned int,
                                                   const Point &,
