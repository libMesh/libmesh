          ...
          case TRI7:
            {
              ...
              const auto bubble_27th = zeta0*zeta1*zeta2;
          ...
          case TRI7:
            {
              ...
              const auto dzeta0dxi  = -1.;
              const auto dzeta1dxi  = 1.;
              const auto dzeta2dxi  = 0.;
              const auto dbubbledxi = zeta2 * (1. - 2.*zeta1 - zeta2);

              const auto dzeta0deta = -1.;
              const auto dzeta1deta = 0.;
              const auto dzeta2deta = 1.;
              const auto dbubbledeta= zeta1 * (1. - zeta1 - 2.*zeta2);
          ...
          case TRI7:
            {
              ...
              const auto dzeta2dxi  = 0.;
              // const auto dbubbledxi = zeta2 * (1. - 2.*zeta1 - zeta2);
              const auto d2bubbledxi2 = -2. * zeta2;

              const auto dzeta0deta = -1.;
              const auto dzeta1deta = 0.;
              const auto dzeta2deta = 1.;
              // const auto dbubbledeta= zeta1 * (1. - zeta1 - 2.*zeta2);
              const auto d2bubbledeta2 = -2. * zeta1;

              const auto d2bubbledxideta = (1. - 2.*zeta1 - 2.*zeta2);
