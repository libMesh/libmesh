    ...
    case 0:
      {
        switch (fet.family)
          {
          case CLOUGH:
            return std::unique_ptr<FEBase>(new FE<0,CLOUGH>(fet));

          case HERMITE:
            return std::unique_ptr<FEBase>(new FE<0,HERMITE>(fet));

          case LAGRANGE:
            return std::unique_ptr<FEBase>(new FE<0,LAGRANGE>(fet));

          case L2_LAGRANGE:
            return std::unique_ptr<FEBase>(new FE<0,L2_LAGRANGE>(fet));

          case HIERARCHIC:
            return std::unique_ptr<FEBase>(new FE<0,HIERARCHIC>(fet));

          case L2_HIERARCHIC:
            return std::unique_ptr<FEBase>(new FE<0,L2_HIERARCHIC>(fet));

          case MONOMIAL:
            return std::unique_ptr<FEBase>(new FE<0,MONOMIAL>(fet));

#ifdef LIBMESH_ENABLE_HIGHER_ORDER_SHAPES
          case SZABAB:
            return std::unique_ptr<FEBase>(new FE<0,SZABAB>(fet));

          case BERNSTEIN:
            return std::unique_ptr<FEBase>(new FE<0,BERNSTEIN>(fet));
#endif

          case XYZ:
            return std::unique_ptr<FEBase>(new FEXYZ<0>(fet));

          case SCALAR:
            return std::unique_ptr<FEBase>(new FEScalar<0>(fet));
    ...
    case 1:
      {
        switch (fet.family)
          {
          case CLOUGH:
            return std::unique_ptr<FEBase>(new FE<1,CLOUGH>(fet));

          case HERMITE:
            return std::unique_ptr<FEBase>(new FE<1,HERMITE>(fet));

          case LAGRANGE:
            return std::unique_ptr<FEBase>(new FE<1,LAGRANGE>(fet));

          case L2_LAGRANGE:
            return std::unique_ptr<FEBase>(new FE<1,L2_LAGRANGE>(fet));

          case HIERARCHIC:
            return std::unique_ptr<FEBase>(new FE<1,HIERARCHIC>(fet));

          case L2_HIERARCHIC:
            return std::unique_ptr<FEBase>(new FE<1,L2_HIERARCHIC>(fet));

          case MONOMIAL:
            return std::unique_ptr<FEBase>(new FE<1,MONOMIAL>(fet));

#ifdef LIBMESH_ENABLE_HIGHER_ORDER_SHAPES
          case SZABAB:
            return std::unique_ptr<FEBase>(new FE<1,SZABAB>(fet));

          case BERNSTEIN:
            return std::unique_ptr<FEBase>(new FE<1,BERNSTEIN>(fet));
#endif

          case XYZ:
            return std::unique_ptr<FEBase>(new FEXYZ<1>(fet));

          case SCALAR:
            return std::unique_ptr<FEBase>(new FEScalar<1>(fet));
    ...
    case 2:
      {
        switch (fet.family)
          {
          case CLOUGH:
            return std::unique_ptr<FEBase>(new FE<2,CLOUGH>(fet));

          case HERMITE:
            return std::unique_ptr<FEBase>(new FE<2,HERMITE>(fet));

          case LAGRANGE:
            return std::unique_ptr<FEBase>(new FE<2,LAGRANGE>(fet));

          case L2_LAGRANGE:
            return std::unique_ptr<FEBase>(new FE<2,L2_LAGRANGE>(fet));

          case HIERARCHIC:
            return std::unique_ptr<FEBase>(new FE<2,HIERARCHIC>(fet));

          case L2_HIERARCHIC:
            return std::unique_ptr<FEBase>(new FE<2,L2_HIERARCHIC>(fet));

          case MONOMIAL:
            return std::unique_ptr<FEBase>(new FE<2,MONOMIAL>(fet));

#ifdef LIBMESH_ENABLE_HIGHER_ORDER_SHAPES
          case SZABAB:
            return std::unique_ptr<FEBase>(new FE<2,SZABAB>(fet));

          case BERNSTEIN:
            return std::unique_ptr<FEBase>(new FE<2,BERNSTEIN>(fet));
#endif

          case XYZ:
            return std::unique_ptr<FEBase>(new FEXYZ<2>(fet));

          case SCALAR:
            return std::unique_ptr<FEBase>(new FEScalar<2>(fet));

          case SUBDIVISION:
            return std::unique_ptr<FEBase>(new FESubdivision(fet));
    ...
    case 3:
      {
        switch (fet.family)
          ...
          case HERMITE:
            return std::unique_ptr<FEBase>(new FE<3,HERMITE>(fet));

          case LAGRANGE:
            return std::unique_ptr<FEBase>(new FE<3,LAGRANGE>(fet));

          case L2_LAGRANGE:
            return std::unique_ptr<FEBase>(new FE<3,L2_LAGRANGE>(fet));

          case HIERARCHIC:
            return std::unique_ptr<FEBase>(new FE<3,HIERARCHIC>(fet));

          case L2_HIERARCHIC:
            return std::unique_ptr<FEBase>(new FE<3,L2_HIERARCHIC>(fet));

          case MONOMIAL:
            return std::unique_ptr<FEBase>(new FE<3,MONOMIAL>(fet));

#ifdef LIBMESH_ENABLE_HIGHER_ORDER_SHAPES
          case SZABAB:
            return std::unique_ptr<FEBase>(new FE<3,SZABAB>(fet));

          case BERNSTEIN:
            return std::unique_ptr<FEBase>(new FE<3,BERNSTEIN>(fet));
#endif

          case XYZ:
            return std::unique_ptr<FEBase>(new FEXYZ<3>(fet));

          case SCALAR:
            return std::unique_ptr<FEBase>(new FEScalar<3>(fet));
    ...
    case 0:
      {
        switch (fet.family)
          {
          case LAGRANGE_VEC:
            return std::unique_ptr<FEVectorBase>(new FELagrangeVec<0>(fet));
    ...
    case 1:
      {
        switch (fet.family)
          {
          case LAGRANGE_VEC:
            return std::unique_ptr<FEVectorBase>(new FELagrangeVec<1>(fet));
    ...
    case 2:
      {
        switch (fet.family)
          {
          case LAGRANGE_VEC:
            return std::unique_ptr<FEVectorBase>(new FELagrangeVec<2>(fet));

          case NEDELEC_ONE:
            return std::unique_ptr<FEVectorBase>(new FENedelecOne<2>(fet));
    ...
    case 3:
      {
        switch (fet.family)
          {
          case LAGRANGE_VEC:
            return std::unique_ptr<FEVectorBase>(new FELagrangeVec<3>(fet));

          case NEDELEC_ONE:
            return std::unique_ptr<FEVectorBase>(new FENedelecOne<3>(fet));
          ...
          case JACOBI_20_00:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<1,JACOBI_20_00,CARTESIAN>(fet));
          ...
          case JACOBI_30_00:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<1,JACOBI_30_00,CARTESIAN>(fet));
          ...
          case LEGENDRE:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<1,LEGENDRE,CARTESIAN>(fet));
          ...
          case LAGRANGE:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<1,LAGRANGE,CARTESIAN>(fet));
          ...
          case JACOBI_20_00:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<2,JACOBI_20_00,CARTESIAN>(fet));
          ...
          case JACOBI_30_00:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<2,JACOBI_30_00,CARTESIAN>(fet));
          ...
          case LEGENDRE:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<2,LEGENDRE,CARTESIAN>(fet));
          ...
          case LAGRANGE:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<2,LAGRANGE,CARTESIAN>(fet));
          ...
          case JACOBI_20_00:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<3,JACOBI_20_00,CARTESIAN>(fet));
          ...
          case JACOBI_30_00:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<3,JACOBI_30_00,CARTESIAN>(fet));
          ...
          case LEGENDRE:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<3,LEGENDRE,CARTESIAN>(fet));
          ...
          case LAGRANGE:
            {
              switch (fet.inf_map)
                {
                case CARTESIAN:
                  return std::unique_ptr<FEBase>(new InfFE<3,LAGRANGE,CARTESIAN>(fet));
