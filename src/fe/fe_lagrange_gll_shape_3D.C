...
LIBMESH_DEFAULT_VECTORIZED_FE(3,LAGRANGE_GLL)
...
template <>
Real FE<3,LAGRANGE_GLL>::shape(const ElemType,
                               const Order,
                               const unsigned int,
                               const Point &)
{
...
template <>
Real FE<3,LAGRANGE_GLL>::shape(const Elem * elem,
                               const Order order,
                               const unsigned int i,
                               const Point & p,
                               const bool add_p_level)
{
  ...
  return fe_lagrange_gll_shape<LAGRANGE_GLL, 3>
    (elem, order + add_p_level*elem->p_level(), i, p, nullptr, 0);
}


template <>
Real FE<3,LAGRANGE_GLL>::shape(const FEType fet,
                               const Elem * elem,
                               const unsigned int i,
                               const Point & p,
                               const bool add_p_level)
...
template <>
Real FE<3,LAGRANGE_GLL>::shape_deriv(const ElemType,
                                     const Order,
                                     const unsigned int,
                                     const unsigned int,
                                     const Point &)
...
template <>
Real FE<3,LAGRANGE_GLL>::shape_deriv(const Elem * elem,
                                     const Order order,
                                     const unsigned int i,
                                     const unsigned int j,
                                     const Point & p,
...
template <>
Real FE<3,LAGRANGE_GLL>::shape_deriv(const FEType fet,
                                     const Elem * elem,
                                     const unsigned int i,
                                     const unsigned int j,
                                     const Point & p,
...
template <>
Real FE<3,LAGRANGE_GLL>::shape_second_deriv(const ElemType,
                                            const Order,
                                            const unsigned int,
                                            const unsigned int,
                                            const Point &)
...
template <>
Real FE<3,LAGRANGE_GLL>::shape_second_deriv(const Elem * elem,
                                            const Order order,
                                            const unsigned int i,
                                            const unsigned int j,
                                            const Point & p,
...
template <>
Real FE<3,LAGRANGE_GLL>::shape_second_deriv(const FEType fet,
                                            const Elem * elem,
                                            const unsigned int i,
                                            const unsigned int j,
                                            const Point & p,
