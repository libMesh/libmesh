              ...
              if (allow_rules_with_negative_weights)
                {
                  ...
                  const Real rule_data[3][4] = {
                    {0.250000000000000000e+00L,                         0.L,                            0.L,  -0.131555555555555556e-01L},  // 1
                    {0.785714285714285714e+00L,   0.714285714285714285e-01L,                            0.L,   0.762222222222222222e-02L},  // 4
                    {0.399403576166799219e+00L,                         0.L,      0.100596423833200785e+00L,   0.248888888888888889e-01L}   // 6
                  };
          ...
          case FIFTH:
            {
              ...
              const Real a[3] = {0.31088591926330060980L,    // a1 from the paper
                                 0.092735250310891226402L,   // a2 from the paper
                                 0.045503704125649649492L};  // a3 from the paper

              // weights.  a[] and wt[] are the only floating-point inputs required
              // for this rule.
              const Real wt[3] = {0.018781320953002641800L,    // w1 from the paper
                                  0.012248840519393658257L,    // w2 from the paper
                                  0.0070910034628469110730L};  // w3 from the paper
          ...
          case SIXTH:
            {
              ...
              const Real rule_data[4][4] = {
                {0.356191386222544953e+00L , 0.214602871259151684e+00L ,                       0.L, 0.00665379170969464506e+00L}, // 4
                {0.877978124396165982e+00L , 0.0406739585346113397e+00L,                       0.L, 0.00167953517588677620e+00L}, // 4
                {0.0329863295731730594e+00L, 0.322337890142275646e+00L ,                       0.L, 0.00922619692394239843e+00L}, // 4
                {0.0636610018750175299e+00L, 0.269672331458315867e+00L , 0.603005664791649076e+00L, 0.00803571428571428248e+00L}  // 12
              };
              ...
              if (allow_rules_with_negative_weights)
                {
                  ...
                  const Real rule_data[7][4] = {
                    {0.250000000000000000e+00L,                        0.L,                        0.L,   -0.393270066412926145e-01L},  // 1
                    {0.617587190300082967e+00L,  0.127470936566639015e+00L,                        0.L,    0.408131605934270525e-02L},  // 4
                    {0.903763508822103123e+00L,  0.320788303926322960e-01L,                        0.L,    0.658086773304341943e-03L},  // 4
                    {0.497770956432810185e-01L,                        0.L,  0.450222904356718978e+00L,    0.438425882512284693e-02L},  // 6
                    {0.183730447398549945e+00L,                        0.L,  0.316269552601450060e+00L,    0.138300638425098166e-01L},  // 6
                    {0.231901089397150906e+00L,  0.229177878448171174e-01L,  0.513280033360881072e+00L,    0.424043742468372453e-02L},  // 12
                    {0.379700484718286102e-01L,  0.730313427807538396e+00,  0.193746475248804382e+00L,    0.223873973961420164e-02L}   // 12
                  };
