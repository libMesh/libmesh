          ...
          case FIFTH:
            {
              ...
              const Real data[3][3] =
                {
                  {                   0,                      0, Real(8)/7  }, // 1
                  {                   0, std::sqrt(Real(14)/15), Real(20)/63}, // 2
          ...
          case FIFTEENTH:
            {
              ...
              const Real data[9][3] =
                {
                  {9.915377816777667e-01_R, 0.0000000000000000e+00 ,  3.01245207981210e-02_R}, // 4
                  {8.020163879230440e-01_R, 0.0000000000000000e+00 ,  8.71146840209092e-02_R}, // 4
                  {5.648674875232742e-01_R, 0.0000000000000000e+00 , 1.250080294351494e-01_R}, // 4
                  {9.354392392539896e-01_R, 0.0000000000000000e+00 ,  2.67651407861666e-02_R}, // 4
                  {7.624563338825799e-01_R, 0.0000000000000000e+00 ,  9.59651863624437e-02_R}, // 4
                  {2.156164241427213e-01_R, 0.0000000000000000e+00 , 1.750832998343375e-01_R}, // 4
                  {9.769662659711761e-01_R, 6.684480048977932e-01_R,  2.83136372033274e-02_R}, // 4
                  {8.937128379503403e-01_R, 3.735205277617582e-01_R,  8.66414716025093e-02_R}, // 4
                  {6.122485619312083e-01_R, 4.078983303613935e-01_R, 1.150144605755996e-01_R}  // 4
                };
