...
INSTANTIATE_FETEST(FOURTH, SZABAB, EDGE3);

#if LIBMESH_DIM > 1
INSTANTIATE_FETEST(FIRST, SZABAB, TRI3);
INSTANTIATE_FETEST(SECOND, SZABAB, TRI6);
INSTANTIATE_FETEST(THIRD, SZABAB, TRI6);
INSTANTIATE_FETEST(FOURTH, SZABAB, TRI6);
INSTANTIATE_FETEST(SECOND, SZABAB, TRI7);
INSTANTIATE_FETEST(THIRD, SZABAB, TRI7);
INSTANTIATE_FETEST(FOURTH, SZABAB, TRI7);
#endif
...
INSTANTIATE_FETEST(FOURTH, SZABAB, QUAD9);
#endif
