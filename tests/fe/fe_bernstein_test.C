...
INSTANTIATE_FETEST(SECOND, BERNSTEIN, TRI7);
INSTANTIATE_FETEST(THIRD, BERNSTEIN, TRI7);
INSTANTIATE_FETEST(FOURTH, BERNSTEIN, TRI7);
...
INSTANTIATE_FETEST(SECOND, BERNSTEIN, TET14);
