...
INSTANTIATE_FEORIENTATIONTEST(QUAD9,   THIRD,  LAGRANGE_GLL);
INSTANTIATE_FEORIENTATIONTEST(QUAD9,   FOURTH, LAGRANGE_GLL);
...
INSTANTIATE_FEORIENTATIONTEST(HEX27,   THIRD,  LAGRANGE_GLL);
INSTANTIATE_FEORIENTATIONTEST(HEX27,   FOURTH, LAGRANGE_GLL);
INSTANTIATE_FEORIENTATIONTEST(HEX27,   FIFTH,  LAGRANGE_GLL);
