...
[
 ...
 AC_ARG_VAR([timpi_CPPFLAGS], [User-specified C/C++ preprocessor flags])
 AC_ARG_VAR([timpi_CXXFLAGS], [User-specified C++ compilation flags])
 AC_ARG_VAR([timpi_CFLAGS],   [User-specified C compilation flags])
 ...
 CPPFLAGS_OPT="$CPPFLAGS_OPT $timpi_CPPFLAGS"
 CXXFLAGS_OPT="$CXXFLAGS_OPT $timpi_CXXFLAGS"
 CFLAGS_OPT="$CFLAGS_OPT $timpi_CFLAGS"

 CPPFLAGS_DBG="$CPPFLAGS_DBG $timpi_CPPFLAGS"
 CXXFLAGS_DBG="$CXXFLAGS_DBG $timpi_CXXFLAGS"
 CFLAGS_DBG="$CFLAGS_DBG $timpi_CFLAGS"

 CPPFLAGS_DEVEL="$CPPFLAGS_DEVEL $timpi_CPPFLAGS"
 CXXFLAGS_DEVEL="$CXXFLAGS_DEVEL $timpi_CXXFLAGS"
 CFLAGS_DEVEL="$CFLAGS_DEVEL $timpi_CFLAGS"
