...
/* Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA */
 ...
 // <h1>Miscellaneous Example 8 - Interior Penalty Discontinuous Galerkin</h1>
 //
 // By Lorenzo Botti
 //
 // This example is based on miscellaneous_ex5, but uses XYZ finite elements
 // instead of MONONOMIAL finite elements.
...
int main (int argc, char** argv)
{
  ...
  GetPot input_file("miscellaneous_ex8.in");
  ...
  ellipticdg_system.add_variable ("u", p_order, XYZ);
