...
INSTANTIATE_MBRF(0,L2_HIERARCHIC);
INSTANTIATE_MBRF(1,L2_HIERARCHIC);
INSTANTIATE_MBRF(2,L2_HIERARCHIC);
INSTANTIATE_MBRF(3,L2_HIERARCHIC);

#ifdef LIBMESH_ENABLE_AMR
template void FE<2,L2_HIERARCHIC>::compute_constraints(DofConstraints&, DofMap&, 
						    const unsigned int,
						    const Elem*);
template void FE<3,L2_HIERARCHIC>::compute_constraints(DofConstraints&, DofMap&, 
						    const unsigned int,
						    const Elem*);
#endif // #ifdef LIBMESH_ENABLE_AMR
