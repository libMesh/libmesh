			  ...
			  const bool write_partitioning)
{
  ...
  this->write_gmv (out, es, write_partitioning);
}
			  ...
			  const bool write_partitioning)
{
  ...
  if (this->processor_id() == 0)
    this->write_gmv (out, &soln, &names, write_partitioning);
}
			  ...
			  const bool write_partitioning)
{
  ...
  this->write_gmv (out, v, solution_names, write_partitioning);
}
			 ...
			 const bool write_partitioning)
{
  ...
  // Begin interfacing with the GMV data file
  {
    ...
    out << "gmvinput ascii" << std::endl << std::endl;
    out << "nodes " << this->n_nodes() << std::endl;
    for (unsigned int v=0; v<this->n_nodes(); v++)
      out << this->point(v)(0) << " ";
  ...
  
  {
    ...
    out << "cells " << this->n_active_sub_elem() << std::endl;
