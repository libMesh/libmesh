// $Id: inf_fe_instantiate_3D.h,v 1.1 2003-01-24 17:24:38 jwpeterson Exp $
 ...
 */
SAY_THAT_INF_FE_IS(template,3,CARTESIAN) 

/* SAY_THAT_INF_FE_IS(template,3,SPHERICAL) */

/* SAY_THAT_INF_FE_IS(template,3,ELLIPSOIDAL) */
