// $Id: morton_sfc_partitioner.h,v 1.1 2003-06-24 05:33:51 benkirk Exp $
...
class MortonSFCPartitioner : public SFCPartitioner
{
 public:
   ...
   */
  MortonSFCPartitioner (MeshBase& mesh) :
    SFCPartitioner(mesh)
  {
   ...
   */
  void partition (const unsigned int n) { SFCPartitioner::partition(n); }
