// $Id: fe_monomial_shape_2D.C,v 1.1.1.1 2003-01-10 16:17:48 libmesh Exp $
...
template <>
real FE<2,MONOMIAL>::shape(const ElemType type,
			    const Order order,
...
template <>
real FE<2,MONOMIAL>::shape_deriv(const ElemType type,
				  const Order order,
				  const unsigned int i,
