// $Id: mesh_ucd_support.C,v 1.13 2004-03-18 15:10:32 jwpeterson Exp $
...
void MeshBase::write_ucd(const std::string& name) const
{
...
void MeshBase::write_ucd (std::ostream &out) const
{
  assert (out);
  ...
  // Write header to stream
  {
	...
	<< "#" << std::endl
	<< "# $Id: mesh_ucd_support.C,v 1.13 2004-03-18 15:10:32 jwpeterson Exp $" << std::endl
	<< "#" << std::endl
