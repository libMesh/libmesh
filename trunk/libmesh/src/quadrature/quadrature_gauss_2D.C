                     ...
                     unsigned int p)
{
  ...
  switch (_type)
    ...
    case QUAD9:
      {
	// Some orders of quadrilaterals have more efficient
	// non tensor-product rules available, and we use
	// those when appropriate.  By default, the tensor product
	// rules are used.
	switch(_order + 2*p)
	  {
	  case FOURTH:
	      ...
	      const Real data[4][3] =
		{
		  ...
		  {0.000000000000000,  0.000000000000000,  1.142857142857143},
		  {0.000000000000000,  0.966091783079296,  0.439560439560440},
		  {0.851914653304601,  0.455603727836193,  0.566072207007532},
		  {0.630912788976754, -0.731629951573135,  0.642719001783677}
		  //
	  ...
	  case SIXTH:
	      ...
	      const Real data[6][3] =
		{
		  ...
		  {0.000000000000000,  0.869833375250059,  0.392750590964348},
		  {0.000000000000000, -0.479406351612111,  0.754762881242610},
		  {0.863742826346154,  0.802837516207657,  0.206166050588279},
		  {0.518690521392582,  0.262143665508058,  0.689992138489864},
		  {0.933972544972849, -0.363096583148066,  0.260517488732317},
		  {0.608977536016356, -0.896608632762453,  0.269567586086061}
		};
	  ...
	  case EIGHTH:
	      ...
	      const Real data[10][3] =
		{
		  ...
		  {0.000000000000000,  0.659560131960342,  0.450276776305590},
		  {0.000000000000000, -0.949142923043125,  0.166570426777813},
		  {0.952509466071562,  0.765051819557684,  0.098869459933431},
		  {0.532327454074206,  0.936975981088416,  0.153696747140812},
		  {0.684736297951735,  0.333656717735747,  0.396686976072903},
		  {0.233143240801405, -0.079583272377397,  0.352014367945695},
		  {0.927683319306117, -0.272240080612534,  0.189589054577798},
		  {0.453120687403749, -0.613735353398028,  0.375101001147587},
		  {0.837503640422812, -0.888477650535971,  0.125618791640072}
		};
