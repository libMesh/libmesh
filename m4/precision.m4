...
if test "$enablesingleprecision" != no ; then
  AS_IF([test "$enabletripleprecision" != no], [AC_MSG_ERROR(<<< Cannot simultaneously default to single and triple precision >>>)],
        [test "$enablequadrupleprecision" != no], [AC_MSG_ERROR(<<< Cannot simultaneously default to single and quadruple precision >>>)],
        [
  ...
  AS_IF([test "$enablequadrupleprecision" != no],
