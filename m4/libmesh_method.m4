...
[
 ...
 CPPFLAGS_OPT="$CPPFLAGS_OPT $libmesh_CPPFLAGS $CPPFLAGS"
 CXXFLAGS_OPT="$CXXFLAGS_OPT $libmesh_CXXFLAGS $CXXFLAGS"
 CFLAGS_OPT="$CFLAGS_OPT $libmesh_CFLAGS $CFLAGS"

 CPPFLAGS_DBG="$CPPFLAGS_DBG $libmesh_CPPFLAGS $CPPFLAGS"
 CXXFLAGS_DBG="$CXXFLAGS_DBG $libmesh_CXXFLAGS $CXXFLAGS"
 CFLAGS_DBG="$CFLAGS_DBG $libmesh_CFLAGS $CFLAGS"

 CPPFLAGS_DEVEL="$CPPFLAGS_DEVEL $libmesh_CPPFLAGS $CPPFLAGS"
 CXXFLAGS_DEVEL="$CXXFLAGS_DEVEL $libmesh_CXXFLAGS $CXXFLAGS"
 CFLAGS_DEVEL="$CFLAGS_DEVEL $libmesh_CFLAGS $CFLAGS"
