...
<pre>
make[4]: Entering directory `/net/spark/workspace/roystgnr/libmesh/git/devel/examples/eigenproblems/eigenproblems_ex2'
***************************************************************
* Running Example eigenproblems_ex2:
*  mpirun -np 4 example-devel -n 5 -eps_type lapack -pc_type bjacobi -sub_pc_type ilu -sub_pc_factor_levels 4 -sub_pc_factor_zeropivot 0 -ksp_right_pc
***************************************************************
 
Running /net/spark/workspace/roystgnr/libmesh/git/devel/examples/eigenproblems/eigenproblems_ex2/.libs/lt-example-devel -n 5 -eps_type lapack -pc_type bjacobi -sub_pc_type ilu -sub_pc_factor_levels 4 -sub_pc_factor_zeropivot 0 -ksp_right_pc
...
|  'HDF5_DIR=/opt/apps/ossw/libraries/hdf5/hdf5-1.8.9/sl6/gcc-system'                                               |
 -------------------------------------------------------------------------------------------------------------------
 ----------------------------------------------------------------------------------------------------------------
| libMesh Performance: Alive time=0.339414, Active time=0.188586                                                 |
 ----------------------------------------------------------------------------------------------------------------
...
|                                                                                                                |
| DofMap                                                                                                         |
|   add_neighbors_to_send_list()     1         0.0006      0.000577    0.0008      0.000844    0.31     0.45     |
|   build_sparsity()                 1         0.0005      0.000461    0.0012      0.001238    0.24     0.66     |
|   create_dof_constraints()         1         0.0002      0.000178    0.0002      0.000178    0.09     0.09     |
|   distribute_dofs()                1         0.0012      0.001222    0.0034      0.003420    0.65     1.81     |
|   dof_indices()                    351       0.0016      0.000005    0.0016      0.000005    0.86     0.86     |
|   prepare_send_list()              1         0.0000      0.000006    0.0000      0.000006    0.00     0.00     |
|   reinit()                         1         0.0018      0.001812    0.0018      0.001812    0.96     0.96     |
|                                                                                                                |
| EquationSystems                                                                                                |
|   build_solution_vector()          1         0.0002      0.000249    0.0011      0.001140    0.13     0.60     |
|                                                                                                                |
| ExodusII_IO                                                                                                    |
|   write_nodal_data()               1         0.0411      0.041082    0.0411      0.041082    21.78    21.78    |
|                                                                                                                |
| FE                                                                                                             |
|   compute_shape_functions()        100       0.0003      0.000003    0.0003      0.000003    0.17     0.17     |
|   init_shape_functions()           1         0.0000      0.000026    0.0000      0.000026    0.01     0.01     |
|                                                                                                                |
| FEMap                                                                                                          |
|   compute_affine_map()             100       0.0003      0.000003    0.0003      0.000003    0.14     0.14     |
|   init_reference_to_physical_map() 1         0.0000      0.000025    0.0000      0.000025    0.01     0.01     |
|                                                                                                                |
| Mesh                                                                                                           |
|   find_neighbors()                 1         0.0008      0.000756    0.0014      0.001387    0.40     0.74     |
|   renumber_nodes_and_elem()        2         0.0001      0.000027    0.0001      0.000027    0.03     0.03     |
|                                                                                                                |
| MeshCommunication                                                                                              |
|   compute_hilbert_indices()        2         0.0020      0.001000    0.0020      0.001000    1.06     1.06     |
|   find_global_indices()            2         0.0003      0.000170    0.0047      0.002351    0.18     2.49     |
|   parallel_sort()                  2         0.0003      0.000167    0.0020      0.000999    0.18     1.06     |
|                                                                                                                |
| MeshOutput                                                                                                     |
|   write_equation_systems()         1         0.0001      0.000063    0.0424      0.042418    0.03     22.49    |
|                                                                                                                |
| MeshTools::Generation                                                                                          |
|   build_cube()                     1         0.0003      0.000256    0.0003      0.000256    0.14     0.14     |
|                                                                                                                |
| MetisPartitioner                                                                                               |
|   partition()                      1         0.0028      0.002799    0.0052      0.005241    1.48     2.78     |
|                                                                                                                |
| Parallel                                                                                                       |
|   allgather()                      9         0.0002      0.000022    0.0003      0.000029    0.10     0.14     |
|   max(bool)                        2         0.0000      0.000003    0.0000      0.000003    0.00     0.00     |
|   max(scalar)                      109       0.0006      0.000005    0.0006      0.000005    0.30     0.30     |
|   max(vector)                      25        0.0002      0.000007    0.0005      0.000019    0.09     0.25     |
|   min(bool)                        126       0.0005      0.000004    0.0005      0.000004    0.25     0.25     |
|   min(scalar)                      103       0.0044      0.000043    0.0044      0.000043    2.35     2.35     |
|   min(vector)                      25        0.0002      0.000008    0.0006      0.000024    0.11     0.32     |
|   probe()                          36        0.0004      0.000012    0.0004      0.000012    0.23     0.23     |
|   receive()                        36        0.0001      0.000003    0.0005      0.000015    0.05     0.28     |
|   send()                           36        0.0001      0.000002    0.0001      0.000002    0.03     0.03     |
|   send_receive()                   40        0.0002      0.000005    0.0008      0.000021    0.10     0.44     |
|   sum()                            20        0.0017      0.000086    0.0022      0.000108    0.91     1.14     |
|                                                                                                                |
| Parallel::Request                                                                                              |
|   wait()                           36        0.0000      0.000001    0.0000      0.000001    0.02     0.02     |
|                                                                                                                |
| Partitioner                                                                                                    |
|   set_node_processor_ids()         1         0.0002      0.000213    0.0023      0.002308    0.11     1.22     |
|   set_parent_processor_ids()       1         0.0001      0.000063    0.0001      0.000063    0.03     0.03     |
|                                                                                                                |
| SlepcEigenSolver                                                                                               |
|   solve_generalized()              1         0.1244      0.124404    0.1244      0.124404    65.97    65.97    |
|                                                                                                                |
| System                                                                                                         |
|   assemble()                       1         0.0009      0.000862    0.0021      0.002066    0.46     1.10     |
 ----------------------------------------------------------------------------------------------------------------
| Totals:                            1180      0.1886                                          100.00            |
 ----------------------------------------------------------------------------------------------------------------
...
*  mpirun -np 4 example-devel -n 5 -eps_type lapack -pc_type bjacobi -sub_pc_type ilu -sub_pc_factor_levels 4 -sub_pc_factor_zeropivot 0 -ksp_right_pc
***************************************************************
make[4]: Leaving directory `/net/spark/workspace/roystgnr/libmesh/git/devel/examples/eigenproblems/eigenproblems_ex2'
</pre>
</div>
<?php make_footer() ?>
</body>
