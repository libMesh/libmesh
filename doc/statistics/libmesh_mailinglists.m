...
membership_indices = [membership_indices, 36+linspace(1,12,12)]; % 2013 <-- Update me
...
devel_data = {
    ...
    {'2013', 168,       151,    30,     145,    26,     53,     76,     33,     23,     72,    122}
    };
...
users_data = {
    ...
    {'2013',    108,    104,   171,     133,   108,    100,     93,     126,    74,     59,     145}
    };
