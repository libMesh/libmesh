...
\includepdf[pages=-,addtotoc={1,section,1,2026,twentysix}]{twentysix}
\includepdf[pages=-,addtotoc={1,section,1,2025,twentyfive}]{twentyfive}
\includepdf[pages=-,addtotoc={1,section,1,2024,twentyfour}]{twentyfour}
\includepdf[pages=-,addtotoc={1,section,1,2023,twentythree}]{twentythree}
\includepdf[pages=-,addtotoc={1,section,1,2022,twentytwo}]{twentytwo}
\includepdf[pages=-,addtotoc={1,section,1,2021,twentyone}]{twentyone}
