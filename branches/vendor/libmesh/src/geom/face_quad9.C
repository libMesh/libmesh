// $Id: face_quad9.C,v 1.1.1.1 2003-01-10 16:17:48 libmesh Exp $
...
std::auto_ptr<Elem> Quad9::build_side (const unsigned int i) const
{
  assert (i < n_sides());
...
unsigned int Quad9::vtk_element_type (const unsigned int sf) const
{
  return 9;
};
