...
[
 ...
 CPPFLAGS_PROF="$CPPFLAGS_OPT $libmesh_CPPFLAGS"
 CXXFLAGS_PROF="$CXXFLAGS_OPT $PROFILING_FLAGS $libmesh_CXXFLAGS"
 CFLAGS_PROF="$CFLAGS_OPT $PROFILING_FLAGS $libmesh_CFLAGS"

 CPPFLAGS_OPROF="$CPPFLAGS_OPT $libmesh_CPPFLAGS"
 CXXFLAGS_OPROF="$CXXFLAGS_OPT $OPROFILE_FLAGS $libmesh_CXXFLAGS"
 CFLAGS_OPROF="$CFLAGS_OPT $OPROFILE_FLAGS $libmesh_CFLAGS"
