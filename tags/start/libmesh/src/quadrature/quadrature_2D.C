// $Id: quadrature_2D.C,v 1.1.1.1 2003-01-10 16:17:48 libmesh Exp $
		     ...
		     const unsigned int side)
{
  ...
  switch (_type)
	...
	switch (side)
	  ...
	  case 0:
	    {
	      for (unsigned int qp=0; qp<q1D.n_points(); qp++)
		{
	...
	switch (side)
	  ...
	  case 1:
	    {
	      for (unsigned int qp=0; qp<q1D.n_points(); qp++)
		{
		  _points[qp](0) = .5*(q1D.qp(q1D.n_points() - (qp +1))(0) + 1.);
	  ...
	  case 2:
		...
		{
		  _points[qp](0) = 0.;
		  _points[qp](1) = .5*(q1D.qp(q1D.n_points() - (qp +1))(0) + 1.);
