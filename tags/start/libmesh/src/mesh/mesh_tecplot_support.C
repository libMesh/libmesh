// $Id: mesh_tecplot_support.C,v 1.1.1.1 2003-01-10 16:17:48 libmesh Exp $
			      ...
			      const std::vector<std::string>* solution_names)
{
  ...
  {
    {
	  ...
	  << "#" << std::endl
	  << "# $Id: mesh_tecplot_support.C,v 1.1.1.1 2003-01-10 16:17:48 libmesh Exp $" << std::endl
	  << "#" << std::endl
  ...
  for (unsigned int i=0; i<n_nodes(); i++)
    {
      vertex(i).write_unformatted(out);
				       ...
				       const std::vector<std::string>* solution_names)
{
  ...
  for (unsigned int v=0; v<n_nodes(); v++)
    {
      tm.nd(0,v) = static_cast<float>(vertex(v)(0));
      tm.nd(1,v) = static_cast<float>(vertex(v)(1));
      tm.nd(2,v) = static_cast<float>(vertex(v)(2));
