...
namespace libMesh
{
  ...
  namespace {
    ...
    unsigned int monomial_n_dofs_per_elem(const ElemType t,
					  const Order o)
    {
      switch (o)
	{
  ...
  template <> unsigned int FE<0,MONOMIAL>::n_dofs_per_elem(const ElemType t, const Order o) { return monomial_n_dofs_per_elem(t, o); }
  template <> unsigned int FE<1,MONOMIAL>::n_dofs_per_elem(const ElemType t, const Order o) { return monomial_n_dofs_per_elem(t, o); }
  template <> unsigned int FE<2,MONOMIAL>::n_dofs_per_elem(const ElemType t, const Order o) { return monomial_n_dofs_per_elem(t, o); }
  template <> unsigned int FE<3,MONOMIAL>::n_dofs_per_elem(const ElemType t, const Order o) { return monomial_n_dofs_per_elem(t, o); }
