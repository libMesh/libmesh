...
#ifndef LIBMESH_CELL_PRISM20_H
#define LIBMESH_CELL_PRISM20_H
...
/**
 * The \p Prism20 is an element in 3D composed of 20 nodes.
 ...
 * \date 2022
 * \brief A 3D prismatic element with 20 nodes.
 */
class Prism20 final : public Prism
{
public:
  ...
  Prism20 (Elem * p=nullptr) :
    Prism(Prism20::n_nodes(), p, _nodelinks_data)
  {}

  Prism20 (Prism20 &&) = delete;
  Prism20 (const Prism20 &) = delete;
  Prism20 & operator= (const Prism20 &) = delete;
  Prism20 & operator= (Prism20 &&) = delete;
  virtual ~Prism20() = default;

  /**
   * \returns \p PRISM20.
   */
  virtual ElemType type () const override { return PRISM20; }
  ...
  { return this->_nodes_on_side_ptr<Prism20>(s); }
  ...
  /**
   * \returns \p Prism20::side_nodes_map[side][side_node] after doing some range checking.
   */
  virtual unsigned int local_side_node(unsigned int side,
                                       unsigned int side_node) const override;

  /**
   * \returns \p Prism20::edge_nodes_map[edge][edge_node] after doing some range checking.
   */
...
protected:
   ...
   * to \p Prism20.  All other second-order nodes are identical
