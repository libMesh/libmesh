...
#ifndef LIBMESH_CELL_PYRAMID14_IMPL_H
#define LIBMESH_CELL_PYRAMID14_IMPL_H
...
bool Pyramid14Templ<RealType>::is_vertex(const unsigned int i) const
{
  if (i < 5)
    return true;
  return false;
...
template <typename RealType>
bool Pyramid14Templ<RealType>::is_edge(const unsigned int i) const
{
  if (i < 5)
    return false;
  if (i == 13)
...
template <typename RealType>
bool Pyramid14Templ<RealType>::is_face(const unsigned int i) const
{
  if (i == 13)
    return true;
  return false;
...
template <typename RealType>
bool Pyramid14Templ<RealType>::is_node_on_side(const unsigned int n,
...
template <typename RealType>
std::vector<unsigned>
Pyramid14Templ<RealType>::nodes_on_side(const unsigned int s) const
{
  libmesh_assert_less(s, this->n_sides());
  auto trim = (s == 4) ? 0 : 3;
...
template <typename RealType>
bool Pyramid14Templ<RealType>::is_node_on_edge(const unsigned int n,
...
template <typename RealType>
bool Pyramid14Templ<RealType>::has_affine_map() const
{
...
template <typename RealType>
Order Pyramid14Templ<RealType>::default_order() const
{
  return SECOND;
}
...
template <typename RealType>
dof_id_type Pyramid14Templ<RealType>::key (const unsigned int s) const
{
  libmesh_assert_less (s, this->n_sides());
...
template <typename RealType>
unsigned int Pyramid14Templ<RealType>::which_node_am_i(unsigned int side,
...
template <typename RealType>
std::unique_ptr<ElemTempl<RealType>> Pyramid14Templ<RealType>::build_side_ptr (const unsigned int i, bool proxy)
{
...
template <typename RealType>
void Pyramid14Templ<RealType>::build_side_ptr (std::unique_ptr<Elem> & side,
...
template <typename RealType>
std::unique_ptr<ElemTempl<RealType>> Pyramid14Templ<RealType>::build_edge_ptr (const unsigned int i)
{
...
template <typename RealType>
void Pyramid14Templ<RealType>::connectivity(const unsigned int libmesh_dbg_var(sc),
                             const IOPackage iop,
...
template <typename RealType>
unsigned int Pyramid14Templ<RealType>::n_second_order_adjacent_vertices (const unsigned int n) const
{
  switch (n)
    {
    case 5:
...
template <typename RealType>
unsigned short int Pyramid14Templ<RealType>::second_order_adjacent_vertex (const unsigned int n,
...
template <typename RealType>
RealType Pyramid14Templ<RealType>::volume () const
{
  ...
  Point
    ...
    x7 = this->point(7), x8 = this->point(8), x9 = this->point(9), x10 = this->point(10), x11 = this->point(11), x12 = this->point(12), x13 = this->point(13);
...
#endif // LIBMESH_CELL_PYRAMID14_IMPL_H
