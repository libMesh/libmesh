...
#ifndef LIBMESH_CELL_PYRAMID_IMPL_H
#define LIBMESH_CELL_PYRAMID_IMPL_H
...
dof_id_type PyramidTempl<RealType>::key (const unsigned int s) const
{
...
template <typename RealType>
unsigned int PyramidTempl<RealType>::which_node_am_i(unsigned int side,
...
template <typename RealType>
std::unique_ptr<ElemTempl<RealType>> PyramidTempl<RealType>::side_ptr (const unsigned int i)
{
...
template <typename RealType>
void PyramidTempl<RealType>::side_ptr (std::unique_ptr<Elem> & side,
...
template <typename RealType>
bool PyramidTempl<RealType>::is_child_on_side(const unsigned int c,
...
template <typename RealType>
bool PyramidTempl<RealType>::is_edge_on_side(const unsigned int e,
                              const unsigned int s) const
{
  libmesh_assert_less (e, this->n_edges());
  libmesh_assert_less (s, this->n_sides());

  return (this->is_node_on_side(Pyramid5::edge_nodes_map[e][0],s) &&
          this->is_node_on_side(Pyramid5::edge_nodes_map[e][1],s));
}
...
#endif // LIBMESH_CELL_PYRAMID_IMPL_H
