...
public:
   ...
   */
  TrilinosPreconditioner (const Parallel::Communicator &comm = libMesh::CommWorld);
...
template <typename T>
inline
TrilinosPreconditioner<T>::TrilinosPreconditioner (const Parallel::Communicator &comm) :
