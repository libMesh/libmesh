...
#ifndef LIBMESH_GHOST_POINT_NEIGHBORS_IMPL_H
#define LIBMESH_GHOST_POINT_NEIGHBORS_IMPL_H
...
void GhostPointNeighborsTempl<RealType>::operator()
   ...
   GhostPointNeighbors::map_type & coupled_elements)
{
  ...
  for (const auto & elem : _mesh.element_ptr_range())
    {
      typename std::unordered_set<const Elem *>::iterator ip_it =
...
#endif // LIBMESH_GHOST_POINT_NEIGHBORS_IMPL_H
