...
public:
   ...
   * Cubit-14.  We can use this flag to work around an issue with TRI3
   * elements in 3D having misnumbered sidesets (numbering is based on
   * the TRISHELL side numbering).
   */
  bool is_cubit14;
