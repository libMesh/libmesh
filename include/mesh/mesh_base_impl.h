...
MeshBaseTempl<RealType>::MeshBaseTempl (const Parallel::Communicator & comm_in,
  ...
  _default_ghosting(libmesh_make_unique<GhostPointNeighborsTempl<RealType>>(*this)),
...
template <typename RealType>
const PointLocatorBaseTempl<RealType> & MeshBaseTempl<RealType>::point_locator () const
{
  libmesh_deprecated();
...
template <typename RealType>
std::unique_ptr<PointLocatorBaseTempl<RealType>> MeshBaseTempl<RealType>::sub_point_locator () const
{
