...
#ifndef LIBMESH_FE_XYZ_SHAPE_2D_IMPL_H
#define LIBMESH_FE_XYZ_SHAPE_2D_IMPL_H
...
typename FEShim<2,XYZ,RealType>::OutputShape FEShim<2,XYZ,RealType>::shape(const ElemType,
                      const Order,
                      const unsigned int,
                      const Point &)
{
...
template <typename RealType>
typename FEShim<2,XYZ,RealType>::OutputShape FEShim<2,XYZ,RealType>::shape(const Elem * elem,
...
template <typename RealType>
typename FEShim<2,XYZ,RealType>::OutputShape FEShim<2,XYZ,RealType>::shape_deriv(const ElemType,
                            const Order,
                            const unsigned int,
                            const unsigned int,
                            const Point &)
...
template <typename RealType>
typename FEShim<2,XYZ,RealType>::OutputShape FEShim<2,XYZ,RealType>::shape_deriv(const Elem * elem,
                            const Order libmesh_dbg_var(order),
                            const unsigned int i,
...
template <typename RealType>
typename FEShim<2,XYZ,RealType>::OutputShape FEShim<2,XYZ,RealType>::shape_second_deriv(const ElemType,
                                   const Order,
                                   const unsigned int,
                                   const unsigned int,
                                   const Point &)
...
template <typename RealType>
typename FEShim<2,XYZ,RealType>::OutputShape FEShim<2,XYZ,RealType>::shape_second_deriv(const Elem * elem,
                                   const Order libmesh_dbg_var(order),
                                   const unsigned int i,
                                   const unsigned int j,
                                   const Point & point_in,
...
#endif // LIBMESH_FE_XYZ_SHAPE_2D_IMPL_H
