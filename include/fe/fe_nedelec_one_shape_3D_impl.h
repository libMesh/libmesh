...
#ifndef LIBMESH_FE_NEDELEC_ONE_SHAPE_3D_IMPL_H
#define LIBMESH_FE_NEDELEC_ONE_SHAPE_3D_IMPL_H
...
typename FEShim<3,NEDELEC_ONE,RealType>::OutputShape FEShim<3,NEDELEC_ONE,RealType>::shape(const ElemType,
                                      const Order,
                                      const unsigned int,
                                      const Point &)
{
...
template <typename RealType>
typename FEShim<3,NEDELEC_ONE,RealType>::OutputShape FEShim<3,NEDELEC_ONE,RealType>::shape(const Elem * elem,
                                      const Order order,
...
template <typename RealType>
typename FEShim<3,NEDELEC_ONE,RealType>::OutputShape FEShim<3,NEDELEC_ONE,RealType>::shape_deriv(const ElemType,
                                            const Order,
                                            const unsigned int,
                                            const unsigned int,
                                            const Point &)
...
template <typename RealType>
typename FEShim<3,NEDELEC_ONE,RealType>::OutputShape FEShim<3,NEDELEC_ONE,RealType>::shape_deriv(const Elem * elem,
                                            const Order order,
                                            const unsigned int i,
...
template <typename RealType>
typename FEShim<3,NEDELEC_ONE,RealType>::OutputShape FEShim<3,NEDELEC_ONE,RealType>::shape_second_deriv(const ElemType,
                                                   const Order,
                                                   const unsigned int,
                                                   const unsigned int,
                                                   const Point &)
...
template <typename RealType>
typename FEShim<3,NEDELEC_ONE,RealType>::OutputShape FEShim<3,NEDELEC_ONE,RealType>::shape_second_deriv(const Elem * elem,
                                                   const Order order,
                                                   const unsigned int i,
                                                   const unsigned int j,
...
#endif // LIBMESH_FE_NEDELEC_ONE_SHAPE_3D_IMPL_H
