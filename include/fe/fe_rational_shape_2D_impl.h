...
#ifndef LIBMESH_FE_RATIONAL_SHAPE_2D_IMPL_H
#define LIBMESH_FE_RATIONAL_SHAPE_2D_IMPL_H
...
typename FEShim<2,RATIONAL_BERNSTEIN,RealType>::OutputShape FEShim<2,RATIONAL_BERNSTEIN,RealType>::shape(const ElemType,
                                     const Order,
                                     const unsigned int,
                                     const Point &)
{
...
template <typename RealType>
typename FEShim<2,RATIONAL_BERNSTEIN,RealType>::OutputShape FEShim<2,RATIONAL_BERNSTEIN,RealType>::shape(const Elem * elem,
                                     const Order order,
                                     ...
                                     const bool add_p_level)
{
  ...
  RealType weighted_shape_i = 0, weighted_sum = 0;
...
template <typename RealType>
typename FEShim<2,RATIONAL_BERNSTEIN,RealType>::OutputShape FEShim<2,RATIONAL_BERNSTEIN,RealType>::shape_deriv(const ElemType,
                                           const Order,
                                           const unsigned int,
                                           const unsigned int,
                                           const Point &)
...
template <typename RealType>
typename FEShim<2,RATIONAL_BERNSTEIN,RealType>::OutputShape FEShim<2,RATIONAL_BERNSTEIN,RealType>::shape_deriv(const Elem * elem,
                                           const Order order,
                                           const unsigned int i,
...
template <typename RealType>
typename FEShim<2,RATIONAL_BERNSTEIN,RealType>::OutputShape FEShim<2,RATIONAL_BERNSTEIN,RealType>::shape_second_deriv(const ElemType,
                                                  const Order,
                                                  const unsigned int,
                                                  const unsigned int,
                                                  const Point &)
...
template <typename RealType>
typename FEShim<2,RATIONAL_BERNSTEIN,RealType>::OutputShape FEShim<2,RATIONAL_BERNSTEIN,RealType>::shape_second_deriv(const Elem * elem,
                                                  const Order order,
                                                  const unsigned int i,
                                                  const unsigned int j,
                                                  const Point & p,
...
#endif // LIBMESH_FE_RATIONAL_SHAPE_2D_IMPL_H
