...
#ifndef LIBMESH_TREE_NODE_IMPL_H
#define LIBMESH_TREE_NODE_IMPL_H
...
bool TreeNode<N,RealType>::insert (const Node * nd)
{
  libmesh_assert(nd);
...
template <unsigned int N, typename RealType>
bool TreeNode<N,RealType>::insert (const Elem * elem)
{
  libmesh_assert(elem);
...
template <unsigned int N, typename RealType>
void TreeNode<N,RealType>::refine ()
{
...
template <unsigned int N, typename RealType>
void TreeNode<N,RealType>::set_bounding_box (const std::pair<Point, Point> & bbox)
{
  bounding_box = bbox;
}
...
template <unsigned int N, typename RealType>
bool TreeNode<N,RealType>::bounds_node (const Node * nd,
...
template <unsigned int N, typename RealType>
bool TreeNode<N,RealType>::bounds_point (const Point & p,
                                Real relative_tol) const
{
...
TreeNode<N,RealType>::create_bounding_box (unsigned int c) const
{
  switch (N)
    {
...
template <unsigned int N, typename RealType>
void TreeNode<N,RealType>::print_nodes(std::ostream & out_stream) const
{
  if (this->active())
    {
...
template <unsigned int N, typename RealType>
void TreeNode<N,RealType>::print_elements(std::ostream & out_stream) const
{
  if (this->active())
    {
      out_stream << "TreeNode Level: " << this->level() << std::endl;
...
template <unsigned int N, typename RealType>
void TreeNode<N,RealType>::transform_nodes_to_elements (std::vector<std::vector<const Elem *>> & nodes_to_elem)
{
  if (this->active())
    {
      elements.clear();
...
template <unsigned int N, typename RealType>
void TreeNode<N,RealType>::transform_nodes_to_elements (std::unordered_map<dof_id_type, std::vector<const Elem *>> & nodes_to_elem)
{
  if (this->active())
    {
      elements.clear();
...
template <unsigned int N, typename RealType>
unsigned int TreeNode<N,RealType>::n_active_bins() const
{
  if (this->active())
    return 1;
...
TreeNode<N,RealType>::find_element (const Point & p,
...
template <unsigned int N, typename RealType>
void
TreeNode<N,RealType>::find_elements (const Point & p,
...
template <unsigned int N, typename RealType>
const ElemTempl<RealType> * TreeNode<N,RealType>::find_element_in_children (const Point & p,
                                                                            const std::set<subdomain_id_type> * allowed_subdomains,
                                                                            Real relative_tol) const
{
  libmesh_assert (!this->active());
...
template <unsigned int N, typename RealType>
void TreeNode<N,RealType>::find_elements_in_children (const Point & p,
                                             std::set<const Elem *> & candidate_elements,
                                             const std::set<subdomain_id_type> * allowed_subdomains,
                                             Real relative_tol) const
{
...
#endif // LIBMESH_TREE_NODE_IMPL_H
