...
#ifndef LIBMESH_LINEAR_PARTITIONER_IMPL_H
#define LIBMESH_LINEAR_PARTITIONER_IMPL_H
...
void LinearPartitionerTempl<RealType>::partition_range(MeshBase & mesh,
...
template <typename RealType>
void LinearPartitionerTempl<RealType>::_do_partition (MeshBase & mesh,
                                       const unsigned int n)
{
...
#endif // LIBMESH_LINEAR_PARTITIONER_IMPL_H
